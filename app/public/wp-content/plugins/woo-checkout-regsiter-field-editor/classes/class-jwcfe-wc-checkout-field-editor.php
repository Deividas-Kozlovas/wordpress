		...
		function jwcfe_checkout_fields_radio_field( $field, $key, $args, $value ) {
			...
			if ( ! empty( $args['options_json'] ) ) {
				...
				foreach ( $args['options_json'] as $option ) {
						...
						$field .= '<input type="radio" id="'.$args['id'].'_'.$option['key'].'" ' . checked( $value, $option['key'], false ) . ' name="' . esc_attr( $key ) . '"';
						if(!empty($args['custom_attributes']) && is_array($args['custom_attributes'])){
							foreach($args['custom_attributes'] as $customattr_key=>$customattr_val){
								$field .= ' '.$customattr_key.'='.'"'.$customattr_val.'" ';
							}
						}
						$field .= 'value="' . esc_attr__( $option['key'], 'jwcfe' ) . '" /> ';

						$field .= '<label for="'.$args['id'].'_'.$option['key'].'">'.esc_html__( $option['text'], 'jwcfe' ).'</label>';
...
?>
<div id="jwcfe_new_field_form_pp" title="<?php echo esc_attr($formTitle); ?>" class="<?php echo esc_attr($addClass); ?> jwcfe_popup_wrapper" style= "margin-left: -5px;">
 <form method="post" id="jwcfe_new_field_form" action="">
        <div class="jwcfe_tabs jwcfe-tabs" style="background-color: black; height: 50px; border-radius: none; width: 100%;">
                    ...
                    <div>
                        ...
                        <div class="rowName ">
                            <div class="fieldlabel">
                                ...
                                <input type="text" id="nameInput" required name="fname" placeholder="<?php esc_attr_e('Billing_first_name', 'jwcfe'); ?>" style="width: 300px; height: 40px; background-color: #F1F2F6;color: #000000; font-size: 12px;font-weight: 400; border-color:lightgray; "/>
                        ...
                        <br>
                         <div class="rowLabel">
                            <div class="fieldlabel">
                                ...
                                <input type="text" id="labelrw" name="flabel" placeholder="<?php esc_attr_e('First name', 'jwcfe'); ?>" style="width: 300px; height: 40px; background-color: #F1F2F6; font-weight: 400;color: #000000; border-color:lightgray;" />
                            </div>
                        </div> 
       ...
       <div id="maxlabel">
        <label class="fieldlabel"><?php esc_html_e('Character limit:', 'jwcfe'); ?></label>
                        ...
                        <div class="rowMaxlength">
                            <div>
                                <input type="number" name="fmaxlength" style="width: 300px; height: 40px; background-color: #F1F2F6; border-color: lightgray; border-radius: 0px;" />
                            </div>
                         </div>
                       ...
                       <div class="fieldlabel"><?php esc_html_e('Validations:', 'jwcfe'); ?></td>
                        ...
                        <div class="rowValidate" >
                        	<div>
                                <select multiple="multiple" name="fvalidate" class="jwcfe-enhanced-multi-select" style="width: 300px; height: 30px; ">
                                    <option value="email"><?php esc_html_e('Email', 'jwcfe'); ?></option>
                                    <option value="phone"><?php esc_html_e('Phone', 'jwcfe'); ?></option>
                                </select>
                                <span style="font-size: 12px; color: #7D7D7D;"><?php esc_html_e('select validation above', 'jwcfe'); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="jwcfe_right_col">
                    <div>
                        ...
                        <div class="rowFieldLabel">
                            <div  style="font-weight: 700; color: #000000;margin-top: 0px; "><?php esc_html_e('Field Type:', 'jwcfe'); ?></div>
                        </div>
                        <div class="rowFieldSelect">
                            <div>
                                <select name="ftype" onchange="jwcfeFieldTypeChangeListner(this)" style="width: 300px; height: 40px; background-color: #F1F2F6; border-color: lightgray;margin-top: 10px;">
                                ...
                                <span style="font-size: 12px; color: #7D7D7D;"><?php esc_html_e('Enter field type', 'jwcfe'); ?></span>
                            </div>
                        </div>
                       <div class="rowCustomText">
                    <div><?php esc_html_e('Type your custom text', 'jwcfe'); ?></div>
                 <div>
          <textarea type="text" name="ftext" placeholder="" style="height: 80px; width: 300px; background-color: #F1F2F6; border-color: lightgray;"></textarea>
    </div>
</div>

    <div class="rowPlaceholder">
    <div style="font-weight: 700; color: #000000;margin-top: 20px;"><?php esc_html_e('Placeholder:', 'jwcfe'); ?></div>
     </div>

   <div class="rowPlaceholder">
    <div>
        <input type="text" name="fplaceholder" style="height: 40px; width: 300px; background-color: #F1F2F6; border-color: lightgray;margin-top: 10px;" />
        <br>
        <span style="font-size: 12px; color:#7D7D7D;"><?php esc_html_e('Enter Your placeholder', 'jwcfe'); ?></span>
    </div>
</div>

<div class="rowClass">
    <div style="font-weight: 700; color: #000000; margin-left: -4px; margin-top: 10px;"><?php esc_html_e('Field Width:', 'jwcfe'); ?></div>
</div>

<div class="rowClass">
    <div>
        <select name="fclass" style="width: 300px; height: 40px; background-color: #F1F2F6; border-color:lightgray; margin-top: 10px; margin-left: -4px;">
			...
			<div class="rowOptions" style="margin-top:-1em">
				<div class="fieldlabel" style="text-align: center; float: left; color: #000000; font-weight: 700;"><?php esc_html_e('Options:', 'jwcfe'); ?>
					<font color="red"><?php echo esc_html__('', 'jwcfe'); ?></font>
				</div>
			</div>
			<div class="rowOptions" style="margin-bottom: 5.5em">
				<div  class= "jwcfe_options">
					<div class="jwcfe-option-list thpladmin-dynamic-row-table">
						<div class="ui-sortable">
							<div class="jwcfe-opt-container">
								<div class="jwcfe-opt-row" style="margin-top:5px;">
									<div style="width: 30%;">
									...
									<div class="action-cell sort ui-sortable-handle"></div>
								</div>
       ...
       <div class="popup_footer">
            ...
            <div style="margin-right: 30px;">
                <input type="checkbox" name="fenabled" id="anabledchk" value="yes" checked style="width: 20px; height: 20px; background-color: white; border-radius: none;" />
                <label for ="anabledchk" style="margin-right: 20px; color: black; font-size: 15px;">Show / Hide</label>
            </div>

            <div style="margin-right: 30px;">
                <input type="checkbox" name="fshowinemail" id="showemailchk" value="email" checked style="width: 20px; height: 20px; background-color: white; border-radius: none;" />
                <label for="showemailchk" style="margin-right: 30px; color: black; font-size: 15px;">Display in Emails</label>
            </div>

            <div style="margin-right:-50px;">
                <input type="checkbox" name="fshowinorder" id="inorderchk"  value="order-review" checked style="width: 20px; height: 20px; background-color: white; border-radius: none; font-size: 15px;" />
	...
	function jwcfe_edit_field_form_pp(){
      ...
      <div id="jwcfe_edit_field_form_pp" title="<?php echo esc_attr($formTitle); ?>" class="<?php echo esc_attr($addClass); ?> jwcfe_popup_wrapper" style= "margin-left: -5px;">
                    ...
                    <div>
                        ...
                        <div class="rowName ">
                            <div class="fieldlabel">
                                ...
                                <input type="text" name="fnameNew" placeholder="<?php esc_attr_e('Billing_first_name', 'jwcfe'); ?>" style="width: 300px; height: 40px; background-color: #F1F2F6;color: #000000; font-size: 12px;font-weight: 400;border-color:lightgray; "/>
                                 <span style="color: #000000; font-size: 12px;font-weight: 400;"><?php esc_html_e('Must be unique for each field', 'jwcfe');
			...
			<div class="rowOptions" style="margin-bottom: 5.5em">
				<div  class= "jwcfe_options">
					<div class="jwcfe-option-list thpladmin-dynamic-row-table">
						<div class="ui-sortable">
							<div class="jwcfe-opt-container">
								<div class="jwcfe-opt-row" style="margin-top:10px;">
...
<div id="message" style="border-left-color: #6B2C88" class="wc-connect updated wcfe-notice">
            ...
            <tr>
                <td width="70%">
                    ...
                    <ul>
                        ...
                        <li><?php esc_html_e('You can talk to support any time if you have any queries','jwcfe'); ?> <a href="<?php echo esc_url('https://jcodex.com/contact-us/'); ?>"><?php esc_html_e('Click here','jwcfe'); ?></a></li>
                        <li><?php esc_html_e('IF you found this plugin helpful,','jwcfe'); ?> <a href="<?php echo esc_url('https://www.paypal.com/donate/?hosted_button_id=QD4H8N3QVLLML'); ?>" style=""><?php esc_html_e('Donate using PayPal','jwcfe'); ?></a></li>
                    </ul>
                </td>

                <td>
                    <a href="https://jcodex.com/plugins/woocommerce-custom-checkout-field-editor/" target="_blank">
                        <button id="purchase" style="background: url('<?php echo plugin_dir_url( dirname( __FILE__ ) ) . 'assets/css/Upgrade-to-premium-version.png'; ?>'); width: 302px; height: 63px; cursor: pointer; border: none;">&nbsp;</button>
                    </a>
                    <br>
                    <a href="https://jcodex.com/dev/docs/woocommerce-custom-checkout-field-editor/" target="_blank" class="doclink">
	...
	function render_checkout_fields_heading_row(){
		...
		<th class="check-column" style="padding-left:0px !important;"><input type="checkbox" style="margin-left:7px; display: none; " onclick="jwcfeSelectAllCheckoutFields(this)"/></th>
...
<td class="td_edit">
    <div  class="f_edit_btn" <?php echo ($options['enabled'] == 1 ? '' : 'disabled') ?> 
         ...
         <img class="edit-icon" src="<?php echo plugin_dir_url(dirname(__FILE__)) . 'assets/css/pencil.png'; ?>" alt="" width="12" height="14">
        <?php _e('', 'jwcfe'); ?>
    </div>
</td>
