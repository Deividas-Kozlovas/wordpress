...
function enqueue_role_selection_scripts()
{
    ...
    $version = '1.7.2'; // Change this version number whenever you update the JS or CSS files
...
function clear_cart()
{
    delete_special_order_images_on_cart_emptied(); // Ensure images are deleted before clearing the cart
    WC()->cart->empty_cart();
